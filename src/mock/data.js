...
export const projectsData = [
  {
    ...
    info: 'A list of local restaurants in South Africa that offer their own delivery services or pick up. Support local instead of letting delivery apps take 30% of every order! Made using a low-code content managment system called Contentful.',
    info2:
